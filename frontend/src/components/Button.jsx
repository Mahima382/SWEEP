...
export default function Button({ href, children, variant = "lime", className = "", ...props }) {
  const variants = {
    ...
    ghost:
      "border-2 border-white/70 bg-white/15 text-white backdrop-blur-sm hover:bg-white hover:text-forest",
    "ghost-dark":
      "border-2 border-leaf/30 bg-white/70 text-forest hover:border-leaf hover:bg-lime",
  };
